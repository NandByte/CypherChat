...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRequestsDatabase = FirebaseDatabase.getInstance("https://cypher-chat-53d4b-default-rtdb.firebaseio.com/").getReference().child("Friend_req").child(mCurrent_user_id);
    ...
    public static  class RequestsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            Picasso.with(ctx).load(thumb_image).placeholder(R.drawable.cypher_small).into(userImageView);
